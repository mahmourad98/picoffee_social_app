...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    showProgressBar = Provider.of<UserProvider>(context, listen: false).showProgressBar;
  ...
  Widget build(BuildContext context) {
    ...
    showProgressBar = Provider.of<UserProvider>(context, listen: true).showProgressBar;
